...
import type { Spacing, ComponentStyle, WithStyleProps } from '@instructure/emotion';
...
type TableProps = TableOwnProps & WithStyleProps<ReturnType<NewComponentTypes['Table']>, TableStyle> & OtherHTMLAttributes<TableOwnProps>;
