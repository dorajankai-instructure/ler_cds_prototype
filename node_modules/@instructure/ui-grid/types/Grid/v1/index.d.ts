...
declare class Grid extends Component<GridProps> {
    ...
    renderChildren(): (string | number | import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | Iterable<import("react").ReactNode> | ComponentElement<GridRowProps, GridRow>)[];
