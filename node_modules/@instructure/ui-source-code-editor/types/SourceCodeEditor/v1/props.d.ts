...
import type { CodeEditorTheme, OtherHTMLAttributes } from '@instructure/shared-types';
...
type SourceCodeEditorProps = SourceCodeEditorOwnProps & WithStyleProps<CodeEditorTheme, Record<keyof SourceCodeEditorStyle, any>> & TextDirectionContextConsumerProps & OtherHTMLAttributes<SourceCodeEditorOwnProps> & WithDeterministicIdProps;
type SourceCodeEditorStyle = ComponentStyle<'codeEditor' | 'label' | 'codeEditorContainer'> & {
    theme: StyleObject;
