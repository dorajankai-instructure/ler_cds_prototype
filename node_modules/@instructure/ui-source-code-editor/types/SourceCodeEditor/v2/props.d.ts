...
type SourceCodeEditorProps = SourceCodeEditorOwnProps & WithStyleProps<ReturnType<NewComponentTypes['SourceCodeEditor']>, Record<keyof SourceCodeEditorStyle, any>> & TextDirectionContextConsumerProps & OtherHTMLAttributes<SourceCodeEditorOwnProps> & WithDeterministicIdProps;
