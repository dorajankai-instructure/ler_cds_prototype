...
import type { AsElementType, TooltipTheme, OtherHTMLAttributes } from '@instructure/shared-types';
...
type TooltipRenderChildren = (args: TooltipRenderChildrenArgs) => React.ReactNode;
...
type PropsPassableToPopover = Omit<PopoverOwnProps, 'isShowingContent' | 'defaultIsShowingContent' | 'on' | 'shouldRenderOffscreen' | 'shouldReturnFocus' | 'placement' | 'color' | 'children' | 'mountNode' | 'constrain' | 'shadow' | 'offsetX' | 'offsetY' | 'positionTarget' | 'renderTrigger' | 'onShowContent' | 'onHideContent' | 'onFocus' | 'onBlur' | 'elementRef' | 'preventTooltip'>;
type TooltipProps = PropsPassableToPopover & TooltipOwnProps & WithStyleProps<TooltipTheme, TooltipStyle> & OtherHTMLAttributes<TooltipOwnProps> & WithDeterministicIdProps;
