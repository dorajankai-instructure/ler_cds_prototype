...
import type { AsElementType, OtherHTMLAttributes, ViewTheme } from '@instructure/shared-types';
...
type ViewOwnProps = {
     ...
     */
    display?: 'auto' | 'inline' | 'block' | 'inline-block' | 'flex' | 'inline-flex' | 'contents' | 'inherit' | 'initial' | 'revert' | 'revert-layer' | 'unset';
