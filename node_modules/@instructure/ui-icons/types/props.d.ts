 ...
 */
type InstUIIconProps = Omit<InstUIIconOwnProps & NewThemeOverrideProp<ReturnType<NewComponentTypes['Icon']>> & OtherHTMLAttributes<InstUIIconOwnProps>, 'children' | 'style' | 'className'>;
