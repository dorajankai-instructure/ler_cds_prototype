...
import type { TopNavBarActionItemsTheme, OtherHTMLAttributes, ChildrenOfType } from '@instructure/shared-types';
import type { ItemChild, TopNavBarItemTooltipType } from '../TopNavBarItem/props';
import type { TopNavBarContextType } from '../TopNavBarContext';
import { TopNavBarActionItems } from './index';
type ActionItemsChild = React.ComponentElement<TopNavBarActionItemsProps, TopNavBarActionItems>;
type TopNavBarActionItemsOwnProps = {
     ...
     */
    renderHiddenItemsMenuTriggerLabel: string | ((hiddenChildrenCount: number) => string);
    /**
     ...
     * they will be accessible via a dropdown menu at the end of the list.
     */
    renderHiddenItemsMenuTriggerTooltip?: TopNavBarItemTooltipType | ((hiddenChildrenCount: number) => TopNavBarItemTooltipType);
    /**
...
type TopNavBarActionItemsProps = TopNavBarActionItemsOwnProps & WithStyleProps<TopNavBarActionItemsTheme, TopNavBarActionItemsStyle> & OtherHTMLAttributes<TopNavBarActionItemsOwnProps> & WithDeterministicIdProps;
type TopNavBarActionItemsStyle = ComponentStyle<'topNavBarActionItems' | 'listItem' | 'dropdownMenuOption' | 'dropdownMenuOptionActive'>;
...
export type { ActionItemsChild, TopNavBarActionItemsProps, TopNavBarActionItemsOwnProps, TopNavBarActionItemsState, TopNavBarActionItemsStyleProps, TopNavBarActionItemsStyle };
export { allowedProps };
