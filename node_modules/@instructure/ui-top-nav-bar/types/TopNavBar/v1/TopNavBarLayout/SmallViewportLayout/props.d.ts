...
import type { TopNavBarLayoutSmallViewportTheme, OtherHTMLAttributes } from '@instructure/shared-types';
...
type SmallViewportLayoutChild = React.ComponentElement<TopNavBarSmallViewportLayoutProps, TopNavBarSmallViewportLayout>;
...
type TopNavBarSmallViewportLayoutOwnProps = CommonTopNavBarLayoutProps & SmallViewportLayoutOwnProps;
type PropKeys = keyof TopNavBarSmallViewportLayoutOwnProps;
type AllowedPropKeys = Readonly<Array<PropKeys>>;
type TopNavBarSmallViewportLayoutProps = TopNavBarSmallViewportLayoutOwnProps & WithStyleProps<TopNavBarLayoutSmallViewportTheme, TopNavBarSmallViewportLayoutStyle> & OtherHTMLAttributes<TopNavBarSmallViewportLayoutOwnProps> & WithDeterministicIdProps;
type TopNavBarSmallViewportLayoutStyle = ComponentStyle<'topNavBarSmallViewportLayout' | 'navbar' | 'inPlaceDialogContainer' | 'inPlaceDialogContainerContent' | 'inPlaceDialogContainerButton' | 'menuTriggerContainer' | 'menuTrigger' | 'dropdownMenuOption' | 'dropdownMenuOptionActive' | 'dropdownMenuOptionWithAvatar' | 'brandContainer' | 'alternativeTitleContainer' | 'trayContainer' | 'globalStyles'> & {
...
export type { SmallViewportLayoutChild, SmallViewportLayoutOwnProps, TopNavBarSmallViewportLayoutProps, TopNavBarSmallViewportLayoutOwnProps, TopNavBarSmallViewportLayoutStyle, TopNavBarSmallViewportLayoutState, TopNavBarSmallViewportLayoutStyleProps };
export { allowedProps };
