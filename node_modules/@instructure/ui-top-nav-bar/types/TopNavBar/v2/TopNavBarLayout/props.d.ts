...
type TopNavBarLayoutProps = TopNavBarLayoutOwnProps & WithStyleProps<ReturnType<NewComponentTypes['TopNavBarLayout']>, null> & OtherHTMLAttributes<TopNavBarLayoutOwnProps>;
declare const commonAllowedProps: CommonAllowedPropKeys;
declare const desktopAllowedProps: DesktopAllowedPropKeys;
declare const smallViewportAllowedProps: SmallViewportAllowedPropKeys;
