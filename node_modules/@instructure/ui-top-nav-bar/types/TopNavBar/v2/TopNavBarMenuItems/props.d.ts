...
type MenuItemsChild = React.ComponentElement<TopNavBarMenuItemsProps, TopNavBarMenuItems>;
type TopNavBarMenuItemsOwnProps = {
     ...
     */
    renderHiddenItemsMenuTriggerLabel: (hiddenChildrenCount: number) => React.ReactNode;
    /**
     ...
     */
    renderHiddenItemsMenuTriggerAriaLabel?: (hiddenChildrenCount: number) => string;
    /**
...
type TopNavBarMenuItemsProps = TopNavBarMenuItemsOwnProps & WithStyleProps<ReturnType<NewComponentTypes['TopNavBarMenuItems']>, TopNavBarMenuItemsStyle> & WithDeterministicIdProps & OtherHTMLAttributes<TopNavBarMenuItemsOwnProps>;
type TopNavBarMenuItemsStyle = ComponentStyle<'topNavBarMenuItems' | 'submenuOption' | 'submenuOptionActive'> & {
    itemSpacing: string;
};
...
export type { MenuItemsChild, TopNavBarMenuItemsProps, TopNavBarMenuItemsOwnProps, TopNavBarMenuItemsStyle, TopNavBarMenuItemsState };
export { allowedProps };
