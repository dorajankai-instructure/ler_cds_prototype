...
declare class Pill extends Component<PillProps, PillState> {
    ...
    ref: Element | null;
    ellipsisRef: HTMLElement | null;
    constructor(props: PillProps);
    componentDidMount(): void;
    componentDidUpdate(): void;
    setTruncation(): void;
    handleRef: (el: Element | null) => void;
    renderPill(focused?: TooltipRenderChildrenArgs['focused'], getTriggerProps?: TooltipRenderChildrenArgs['getTriggerProps']): import("@emotion/react/jsx-runtime").JSX.Element;
