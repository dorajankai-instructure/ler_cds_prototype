import type { AsElementType, OtherHTMLAttributes, Renderable } from '@instructure/shared-types';
...
type OptionsItemRenderProps = {
     ...
     */
    variant?: 'default' | 'highlighted' | 'selected' | 'disabled' | 'highlighted-disabled' | 'selected-highlighted';
    /**
...
type OptionsItemProps = OptionsItemOwnProps & WithStyleProps<ReturnType<NewComponentTypes['OptionsItem']>, OptionsItemStyle> & WithDeterministicIdProps & OtherHTMLAttributes<OptionsItemOwnProps>;
