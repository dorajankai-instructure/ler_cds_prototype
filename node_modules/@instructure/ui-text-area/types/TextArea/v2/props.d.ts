...
type TextAreaProps = PickPropsWithExceptions<FormFieldOwnProps, 'label' | 'inline' | 'id' | 'elementRef'> & TextAreaOwnProps & NewThemeOverrideProp<ReturnType<NewComponentTypes['TextArea']>> & OtherHTMLAttributes<TextAreaOwnProps, TextareaHTMLAttributes<TextAreaOwnProps & Element>> & WithDeterministicIdProps;
