...
import type { LiveRegion, UIElement, Renderable } from '@instructure/shared-types';
...
type PopoverProps = PopoverOwnProps & TextDirectionContextConsumerProps & WithDeterministicIdProps & WithStyleProps<ReturnType<NewComponentTypes['Popover']>, PopoverStyle>;
type PopoverState = {
