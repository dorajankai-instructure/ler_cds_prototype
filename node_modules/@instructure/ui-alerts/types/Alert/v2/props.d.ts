...
type AlertProps = AlertOwnProps & WithStyleProps<ReturnType<NewComponentTypes['Alert']>, AlertStyle> & WithDeterministicIdProps;
type AlertStyle = ComponentStyle<'alert' | 'icon' | 'closeButton' | 'content' | 'variantScreenReaderLabel'>;
