...
declare class Calendar extends Component<CalendarProps, CalendarState> {
    ...
    static allowedProps: readonly (keyof {
        ...
        children?: ReactElement<import("./Day/props").CalendarDayProps>[];
        currentDate?: string;
    ...
    handleMonthChange: (direction: "prev" | "next") => (e: React.MouseEvent) => void;
    handleYearChange: (e: React.SyntheticEvent<Element, Event>, year: string) => void;
    renderHeader(): import("@emotion/react/jsx-runtime").JSX.Element;
    renderBody(): import("@emotion/react/jsx-runtime").JSX.Element;
    renderWeekdayHeaders(): import("@emotion/react/jsx-runtime").JSX.Element;
    get defaultWeekdays(): Renderable<never>[];
    renderDays(): import("@emotion/react/jsx-runtime").JSX.Element[];
    locale(): string;
    timezone(): string;
    handleDayClick: (event: MouseEvent<any>, { date }: {
        date: string;
    }) => void;
    isDisabledDate(date: Moment): boolean;
    renderDefaultdays(): import("@emotion/react/jsx-runtime").JSX.Element[];
