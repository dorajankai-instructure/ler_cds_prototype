...
---
**/
declare class SideNavBar extends Component<SideNavBarProps, SideNavBarState> {
    ...
    static Item: typeof SideNavBarItem;
    ref: Element | null;
    constructor(props: SideNavBarProps);
    componentDidMount(): void;
    componentDidUpdate(): void;
    get minimized(): boolean;
    isControlled(props?: Readonly<SideNavBarProps>): boolean;
    ...
    renderIcon(): ReactElement<any, string | import("react").JSXElementConstructor<any>>;
