...
import type { OptionsProps, OptionsSeparatorProps } from '@instructure/ui-options/latest';
...
import { SelectedGroupOptionsMap } from './props';
import type { DrilldownProps, DrilldownStyleProps, DrilldownState, PageChild, OptionChild, GroupChild, SeparatorChild } from './props';
type OptionData = {
...
---
**/
declare class Drilldown extends Component<DrilldownProps, DrilldownState> {
    ...
    static allowedProps: readonly (keyof {
        ...
        defaultShow?: boolean;
        show?: boolean;
        onToggle?: (event: React.UIEvent | React.FocusEvent, args: {
            shown: boolean;
            drilldown: Drilldown;
            pageHistory: string[];
        ...
        onSelect?: (event: React.SyntheticEvent, args: {
        ...
        positionTarget?: import("@instructure/ui-position").PositionMountNode;
    ...
    static Group: typeof DrilldownGroup;
    static Option: typeof DrilldownOption;
    static Page: typeof DrilldownPage;
    static Separator: typeof DrilldownSeparator;
    private _drilldownRef;
    private _popover;
    private _trigger;
    ...
    private readonly _pageHistory;
    _activeOptionsMap: {
        [optionId: string]: MappedOption;
    };
    ref: HTMLDivElement | Element | null;
    handleRef: (el: HTMLDivElement | Element | null) => void;
    handleDrilldownRef: (el: Element | null) => void;
    constructor(props: DrilldownProps);
    componentDidMount(): void;
    componentDidUpdate(_prevProps: DrilldownProps, prevState: DrilldownState): void;
    get makeStylesVariables(): DrilldownStyleProps;
    get activeOptionIds(): string[];
    get activeOptions(): MappedOption[];
    get pages(): PageChild[];
    ...
    get currentPageAriaLabel(): string | undefined;
    getChildrenArray<C extends PageChildren | GroupChildren = PageChildren>(children?: C | C[]): C[];
    getPageById(id?: string): MappedPage | undefined;
    getPageChildById(id?: string): MappedOption | undefined;
    getNormalizedMap(map: Map<string, DrilldownOptionValue>): [string, DrilldownOptionValue][];
    /**
     ...
     */
    getSelectedGroupOptionsMap(): SelectedGroupOptionsMap;
    get selectedGroupOptionIdsArray(): string[];
    get headerChildren(): PageChildren[];
    get shown(): boolean;
    containsDuplicateChild(children: PageChildren[]): boolean;
    ...
    handleOptionHighlight: (_event: React.SyntheticEvent, { id, direction }: {
        id?: string;
        direction?: -1 | 1;
    }) => void;
    goToPage: (newPageId: string) => {
    ...
    handleGroupOptionSelected(event: React.SyntheticEvent, selectedOption: MappedOption): void;
    handleOptionSelect: (event: React.SyntheticEvent, { id }: {
        id?: string;
    }) => void;
    handleKeyDown: (event: React.KeyboardEvent) => void;
    handleToggle: (event: React.UIEvent | React.FocusEvent, shown: boolean) => void;
    getFirstOption: () => OptionChild | undefined;
    renderList(getOptionProps: SelectableRender['getOptionProps'], getDisabledOptionProps: SelectableRender['getDisabledOptionProps']): (import("@emotion/react/jsx-runtime").JSX.Element | (ReactElement<OptionsProps, string | import("react").JSXElementConstructor<any>> | ReactElement<OptionsSeparatorProps, string | import("react").JSXElementConstructor<any>>)[] | null)[] | null;
    renderSeparator(separator: SeparatorChild): import("@emotion/react/jsx-runtime").JSX.Element;
    renderOption(option: OptionChild, getOptionProps: SelectableRender['getOptionProps'], getDisabledOptionProps: SelectableRender['getDisabledOptionProps'], groupProps?: DrilldownGroupProps): import("@emotion/react/jsx-runtime").JSX.Element | null;
    renderGroup(group: GroupChild, getOptionProps: SelectableRender['getOptionProps'], getDisabledOptionProps: SelectableRender['getDisabledOptionProps'], needsFirstSeparator: boolean, needsLastSeparator: boolean): (ReactElement<OptionsProps, string | import("react").JSXElementConstructor<any>> | ReactElement<OptionsSeparatorProps, string | import("react").JSXElementConstructor<any>>)[] | null;
    renderPage(): import("@emotion/react/jsx-runtime").JSX.Element | null;
