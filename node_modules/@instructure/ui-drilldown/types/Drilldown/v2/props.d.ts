...
import type { OtherHTMLAttributes, AsElementType } from '@instructure/shared-types';
...
import type { DrilldownOptionProps, DrilldownOptionValue } from './DrilldownOption/props';
...
type SeparatorChild = React.ComponentElement<DrilldownSeparatorProps, DrilldownSeparator>;
...
type DrilldownProps = DrilldownOwnProps & WithStyleProps<ReturnType<NewComponentTypes['Drilldown']>, DrilldownStyle> & WithDeterministicIdProps & OtherHTMLAttributes<DrilldownOwnProps>;
type DrilldownStyle = ComponentStyle<'drilldown' | 'container' | 'headerBack' | 'headerTitle' | 'optionContainer' | 'optionLabelInfo' | 'optionContent'> & {
...
export type { DrilldownProps, DrilldownState, DrilldownStyle, DrilldownStyleProps, DrilldownPageProps, PageChild, GroupChild, OptionChild, SeparatorChild, SelectedGroupOptionsMap };
export { allowedProps };
