...
type AiInformationProps = AiInformationOwnProps & NewThemeOverrideProp<ReturnType<NewComponentTypes['AiInformation']>> & OtherHTMLAttributes<AiInformationOwnProps>;
type AiInformationStyle = ComponentStyle<'aiInformation' | 'header' | 'privacyNotice' | 'featureName' | 'permissionLevelText' | 'permissionLevel' | 'description' | 'permissionLevelsModalTriggerText' | 'modelNameText' | 'modelName' | 'divider'> & {
    maxWidth?: string;
};
