...
type UpdateMatches = (matches: QueriesMatching, cb?: (...args: any[]) => any) => void;
/**
 ...
 */
type QueryMatchListener = (query: BreakpointQueries, el: Node | Window | React.ReactElement | React.Component | ((...args: any[]) => Node | Window | React.ReactElement | React.Component), cb: UpdateMatches, matchMedia?: (query: string, el: UIElement) => MediaQueryList | null | undefined) => {
    remove: () => void;
};
