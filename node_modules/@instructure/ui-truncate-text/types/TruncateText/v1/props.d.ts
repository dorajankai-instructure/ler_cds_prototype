...
type TruncateTextProps = TruncateTextOwnProps & WithStyleProps<TruncateTextTheme, TruncateTextStyle>;
type TruncateTextStyle = ComponentStyle<'truncateText' | 'auto' | 'spacer' | 'lineHeight'>;
