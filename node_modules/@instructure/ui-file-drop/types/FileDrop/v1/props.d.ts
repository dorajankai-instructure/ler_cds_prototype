...
import type { FileDropTheme, OtherHTMLAttributes } from '@instructure/shared-types';
...
type FileDropProps = FileDropOwnProps & WithStyleProps<FileDropTheme, FileDropStyle> & OtherHTMLAttributes<FileDropOwnProps> & WithDeterministicIdProps;
type FileDropStyle = ComponentStyle<'fileDropLabel' | 'fileDropInput' | 'fileDropLabelContent' | 'fileDropLayout'>;
