...
import type { ComponentStyle, NewThemeOverrideProp, Spacing } from '@instructure/emotion';
...
type NumberInputProps = PickPropsWithExceptions<FormFieldOwnProps, 'label' | 'inline' | 'id' | 'elementRef'> & NumberInputOwnProps & NewThemeOverrideProp<ReturnType<NewComponentTypes['TextInput']>> & OtherHTMLAttributes<NumberInputOwnProps, InputHTMLAttributes<NumberInputOwnProps & Element>> & WithDeterministicIdProps;
