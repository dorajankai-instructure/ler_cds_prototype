...
declare class TreeBrowser extends Component<TreeBrowserProps, TreeBrowserState> {
    ...
    static defaultProps: {
        ...
        collectionIcon: import("react").ComponentType<import("@instructure/ui-icons").InstUIIconProps>;
        collectionIconExpanded: import("react").ComponentType<import("@instructure/ui-icons").InstUIIconProps>;
        itemIcon: import("react").ComponentType<import("@instructure/ui-icons").InstUIIconProps>;
    ...
    handleKeyDown: (event: React.KeyboardEvent, node?: CollectionData) => void;
    ...
    getSelection(state: TreeBrowserState, props: TreeBrowserProps): string;
    ...
    renderRoot(): import("@emotion/react/jsx-runtime").JSX.Element[];
