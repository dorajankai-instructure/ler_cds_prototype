...
type TreeBrowserOwnProps = {
     ...
     */
    onSelectionChange?: (selection: string, type: 'item' | 'collection', id: string | number | undefined) => void;
...
type TreeBrowserProps = TreeBrowserOwnProps & WithStyleProps<ReturnType<NewComponentTypes['TreeBrowser']>, TreeBrowserStyle>;
...
type CompareCollection = CollectionProps & {
    type: 'collection';
};
type CompareItem = CollectionItem & {
    type: 'item';
};
