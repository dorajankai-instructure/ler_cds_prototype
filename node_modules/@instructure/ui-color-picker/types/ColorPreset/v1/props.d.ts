...
import type { OtherHTMLAttributes, ColorPresetTheme } from '@instructure/shared-types';
...
type ColorPresetProps = ColorPresetOwnProps & WithStyleProps<ColorPresetTheme, ColorPresetStyle> & OtherHTMLAttributes<ColorPresetOwnProps>;
type ColorPresetStyle = ComponentStyle<'colorPreset' | 'addNewPresetButton' | 'selectedIndicator' | 'popoverContent' | 'popoverDivider' | 'popoverFooter' | 'label' | 'popoverContrastBlock'>;
declare const allowedProps: AllowedPropKeys;
export type { ColorPresetProps, ColorPresetStyle, ColorPresetState, ContrastStrength };
export { allowedProps };
