...
import type { ColorPickerTheme, OtherHTMLAttributes } from '@instructure/shared-types';
...
type ColorPickerProps = ColorPickerOwnProps & WithStyleProps<ColorPickerTheme, ColorPickerStyle> & OtherHTMLAttributes<ColorPickerOwnProps>;
type ColorPickerStyle = ComponentStyle<'colorPicker' | 'simpleColorContainer' | 'hashMarkContainer' | 'errorIcons' | 'successIcon' | 'label' | 'popoverContent' | 'popoverContentBlock' | 'popoverFooter' | 'colorMixerButtonContainer' | 'popoverContentContainer' | 'colorMixerButtonWrapper'>;
declare const allowedProps: AllowedPropKeys;
export type { ColorPickerProps, ColorPickerStyle, ColorPickerState, ContrastStrength };
export { allowedProps };
