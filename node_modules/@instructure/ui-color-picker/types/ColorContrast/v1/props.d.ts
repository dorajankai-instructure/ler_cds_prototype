...
import type { OtherHTMLAttributes, ColorContrastTheme } from '@instructure/shared-types';
...
type ColorContrastProps = ColorContrastOwnProps & WithStyleProps<ColorContrastTheme, ColorContrastStyle> & OtherHTMLAttributes<ColorContrastOwnProps>;
type ColorContrastStyle = ComponentStyle<'colorContrast' | 'successDescription' | 'failureDescription' | 'statusWrapper' | 'colorIndicator' | 'statusIndicatorWrapper' | 'colorIndicatorLabel' | 'pickedColorHex' | 'colorPreview' | 'firstColorPreview' | 'secondColorPreview' | 'label' | 'onContrastChange' | 'validationLevel'>;
