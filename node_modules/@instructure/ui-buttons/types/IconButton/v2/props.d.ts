...
import type { ToProp, AsElementType, OtherHTMLAttributes, Renderable } from '@instructure/shared-types';
...
type IconButtonProps = IconButtonOwnProps & WithStyleProps<ReturnType<NewComponentTypes['BaseButton']>, null> & OtherHTMLAttributes<IconButtonOwnProps> & ToProp;
