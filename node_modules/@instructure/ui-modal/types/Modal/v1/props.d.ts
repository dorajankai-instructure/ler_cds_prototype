...
import type { AsElementType, ModalTheme, OtherHTMLAttributes, LiveRegion, UIElement } from '@instructure/shared-types';
...
type ModalProps = ModalOwnProps & WithStyleProps<ModalTheme, ModalStyle> & OtherHTMLAttributes<ModalOwnProps>;
type ModalStyle = ComponentStyle<'modal' | 'constrainContext' | 'joinedHeaderAndBody'>;
type ModalState = {
