...
declare class Tabs extends Component<TabsProps, TabsState> {
    ...
    clonePanel(index: number, generatedId: string, selected: boolean, panel: PanelChild, activePanel?: PanelChild): PanelChild;
    handleFocusableRef: (el: Focusable | null) => void;
    handleTabListRef: (el: Element | null) => void;
    focus(): void;
    handleScroll: (event: React.UIEvent<ViewOwnProps> & React.UIEvent<HTMLElement>) => void;
