...
type TabsProps = TabsOwnProps & TextDirectionContextConsumerProps & WithStyleProps<TabsTheme, TabsStyle> & OtherHTMLAttributes<TabsOwnProps>;
type TabsStyle = ComponentStyle<'tabs' | 'container' | 'tabList' | 'panelsContainer' | 'startScrollOverlay' | 'endScrollOverlay'> & {
